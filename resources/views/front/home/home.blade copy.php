    ...
    <div class="container">
        ...
        <!-- <div class="swiper-container sb-blog-slider-3i">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="{{ route('blogs.show', $blog->id) }}" class="sb-blog-card sb-mb-30">
                        <div class="sb-cover-frame sb-mb-30 sb-bdl">
                            <img src="{{ $blog->image }}" alt="cover">
                            <div class="sb-badge">{{ $blog->views }} Reads</div>
                        </div>
                        <div class="sb-blog-card-descr">
                            <h3 class="sb-mb-10">{{ $blog->title }}</h3>
                            <div class="sb-suptitle sb-mb-15"><span>{{ $blog->date }}</span> <span>{{ $blog->author }}</span></div>
                            <p class="sb-fld">{{ $blog->heading }}</p>
                        </div>
                    </a>
                </div>
                @endforeach
