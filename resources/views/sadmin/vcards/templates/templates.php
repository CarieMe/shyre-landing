...
<script id="vcardActionTemplate" type="text/x-jsrender">
    ...
    <a id="vcardUrl{{:id}}" target="_blank" class="text-primary" href="{{:vcardViewUrl}}"> {{:vcardViewUrl}} </a>
    <button class="btn btn-active-color-primary btn-icon btn-sm btn-outline-light copy-clipboard" data-id="{{:id}}" title="{{:copy}}">
