...
<div class="modal fade" id="changeUserPasswordModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            {{ Form::open(['id'=>'changeUserPasswordForm']) }}
            @csrf
            @method('PUT')
            <div class="modal-body">
                <div class="alert alert-danger d-none" id="editUserPasswordValidationErrorsBox"></div>
                <div class="mb-5">
                    {{ Form::hidden('user_id',null,['id'=>'changePasswordUserId']) }}
            ...
            <div class="modal-footer pt-0">
                {{ Form::button(__('messages.common.save'),['class' => 'btn btn-primary m-0','id' => 'UserPasswordChangeBtn']) }}
