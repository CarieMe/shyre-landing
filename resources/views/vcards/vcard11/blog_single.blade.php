                    ...
                    <div class="col-lg-8">
                        <div class="blog-post mb-4">
                            <div class="section-heading mb-4">
                                <h2 class="fs-22 text-white ps-4 mb-1">BLOG POST TITLE</h2>
                                <div class="ps-4">
                                    <span class="fs-14 "><i class="fa-regular fa-calendar"></i></span>
                                    <span class="fs-12 text-white">15 MARCH 2022</span>
                                </div>
                            </div>
                            <div class="mb-4">
                                <div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('assets/img/vcard11/blog-post1.jpeg') }}"
                            ...
                            <div class="blog-post-desc ">
                                <div class="desc d-flex flex-wrap align-items-center mb-4 pt-2">
                                    ...
                                    <div class="">
                                        ...
                                        <span class="fs-12 text-white">6 commnets</span>
                                    </div>
                                </div>
                                <p class="fs-14 text-white mb-4">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare sem sed quam
                                    tempus aliquet vitae eget dolor. Proin eu ultrices libero. Curabitur vulputate
                                    vestibulum elementum. Suspendisse id neque a nibh mollis blandit. Quisque varius
                                    eros ac purus dignissim. Proin eu ultrices libero. Curabitur vulputate vestibulum
                    ...
                    <div class="col-lg-4">
                        ...
                        <!-- start tags-section -->
                            ...
                            <div class="last-post-section mb-4">
                                <div class="section-heading mb-4">
                                    <h2 class="fs-22 text-white ps-4">Last Posts</h2>
                                </div>
